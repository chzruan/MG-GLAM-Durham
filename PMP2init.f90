...
Module Param
    ...
    ! MG - MG flag
    ! Logical  :: MG_flag=.FALSE. ! MG flag
    ! Logical  :: MG_test=.FALSE. ! MG test flag
    Integer*4  :: MG_flag = 0 ! MG flag
    Integer*4  :: MG_test = 0 ! MG test flag
    ...
    Integer*4  :: N_branch = 0
    Integer*4  :: S_branch = 0
    Real*8   :: H0rc
    !
